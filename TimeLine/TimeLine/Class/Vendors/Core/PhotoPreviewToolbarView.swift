...
class PhotoPreviewToolbarView: UIView {
    ...
    private func configView(){
        ...
        backArrow.addTarget(self, action: #selector(eventBackArrow), forControlEvents: .TouchUpInside)
        ...
        checkbox!.addTarget(self, action: #selector(eventCheckbox(_:)), forControlEvents: .TouchUpInside)
